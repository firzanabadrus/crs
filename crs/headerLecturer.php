...
<nav class="navbar navbar-expand-lg bg-light" data-bs-theme="light">
  ...
  <img src="img/logocrs.png" alt="CRS Logo" style="width: 100px; height: auto;">
    ...
    <div class="collapse navbar-collapse" id="navbarColor03">
      ...
      <li class="nav-item">
          <a class="nav-link active" href="viewLecturer.php">Home
            <span class="visually-hidden">(current)</span>
          </a>
        <!-- </li>
        <li class="nav-item">
          <a class="nav-link active" href="courseapproval.php">Approval
          </a>
        </li> -->
        <li class="nav-item">
          <a class="nav-link" href="courseassign.php">Course Assigned</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="courselist.php">Student List</a>
        </li>
        <!-- <li class="nav-item">
